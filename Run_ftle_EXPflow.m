...
init_file = 'user_init_PIV_fiber_St10_minus5_PIV_adim_200rpm';
run(init_file);
...
% Program init checks2_Vinit0.fig
% ===================
% Check flow field and particle type
% ----------------------------------
if( ~ismember(flow_field, {'double_gyre', 'rotor_oscillator','piv'} ) )
...
% Integrate particle trajectories with RK4 periodic boundary conditions
% -------------------------------
[State_out, t_out] = RK4_PBC( State_init, t_init, t_fin, DT, RHS, out_period, DX, DY );
...
%     Xtrac = X;
%     Ytrac = Y;
%     [Ltrac Ctrac] = size(X(:,:,t));
%     
%     figure; hold on;
%     
%     plot(Xtrac(1:1:Ltrac,1:1:Ctrac,t),Ytrac(1:1:Ltrac,1:1:Ctrac,t),'ok', 'MarkerSize', 2);
%     set(gca,'DataAspectRatio',[1 1 1]);
%     
%     saveas( figure(1), full_file_name);
%end
