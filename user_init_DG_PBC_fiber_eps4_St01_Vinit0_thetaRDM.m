...
fiber_parameters.St  = 0.1;     % particle Stokes number
...
result_file = 'DG_PBC_fiber_eps4_St01_thetaRDM_Vinit0_T20';
...
ttl         = 'doublegyre PBC fiber eps=4 St=0.1 theta=RDM T=20';
