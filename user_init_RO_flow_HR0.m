...
RO_generator_parameters.a       = 0.003      ;   % rotor radius in m
RO_generator_parameters.h       = 0.01       ;   % tank half width in m
RO_generator_parameters.c       = 0.7       ;   % distance of the center of the rotor to the closest tank wall in m

% rotor oscillator flow parameters
RO_parameters.eps       = 0       ;   % amplitude of oscillation
RO_parameters.omega     = 3*2*pi/60    	;   % pulsation of oscillation
...
RO_generator_save   = true  ;  % save or not RO interpolant
RO_generator_load   = false   ;  % load or not RO interpolant
...
fiber_parameters.St  = 0.03;     % particle Stokes number
...
% Result file
% -----------
result_file = 'RO_flow_steady_HR';
%result_file = 'RO_fiber_V_U_th_0_T_20_St003_eps4_steadyflow_TEST_1e3';
%result_file = 'doublegyre_fiber_eps4_St003_thetaRDM_Vinit0_T40';
...
%ttl         = 'doublegyre fiber eps=4 St=0.03 theta=RDM T=40';
