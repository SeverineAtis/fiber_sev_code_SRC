...
RO_generator_parameters.h       = 0.045       ;   % add description here
RO_generator_parameters.c       = 0.02       ;   % add description here

% rotor oscillator flow parameters
RO_parameters.eps       = 0       ;   % amplitude of oscillation
RO_parameters.omega     = 0    ;   % pulsation of oscillation
...
RO_parameters.amp_omega = 100*2*pi/60 ;   % amplitude pulsation
