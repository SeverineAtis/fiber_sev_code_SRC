...
% Parameters for sphere particles
 sphere_parameters.st  = 0.5 ;     % particle Stokes number
...
PIV_parameters.dx      = 1.e-3      ;           % add description here
PIV_parameters.dy      = 1.e-3      ;           % add description here
PIV_parameters.dcl     = 1.e-5      ;           % add description here
