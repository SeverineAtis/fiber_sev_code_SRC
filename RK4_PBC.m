function [State_out, t_out] = RK4(State_init, t_init, t_fin, dt, RHS, out_period, DX, DY)
   ...
   for k_step = 1:n_step
      ...
      %------------------------------------------------------
      % particles positions with periodic boundary conditions
      
        State_cur = PBC_XY (State_cur, DX, DY);
