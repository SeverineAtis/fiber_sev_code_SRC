...
fiber_parameters.eps = 6    ;     % ellipse aspect ratio: epsilon =  b/a
...
result_file = 'doublegyre_PBC_fiber_eps6_St002_thetaRDM_Vinit0_T20';
...
ttl         = 'doublegyre PBC fiber eps=6 St=0.02 theta=RDM T=20';
