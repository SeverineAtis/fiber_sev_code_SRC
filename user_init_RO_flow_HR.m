...
RO_generator_parameters.c       = 0.54       ;   % distance of the center of the rotor to the closest tank wall in m
...
RO_generator_file   = '../INPUT/RO_interpolant_01_1e2' ;  % file where interpolant is read or written 
