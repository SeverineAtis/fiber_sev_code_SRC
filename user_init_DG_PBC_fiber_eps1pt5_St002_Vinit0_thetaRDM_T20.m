...
fiber_parameters.eps = 1.5    ;     % ellipse aspect ratio: epsilon =  b/a
...
result_file = 'doublegyre_PBC_test_fiber_eps1pt5_St002_thetaRDM_Vinit0_T20';
...
ttl         = 'doublegyre PBC TEST fiber eps=1.5 St=0.02 theta=RDM T=20';
