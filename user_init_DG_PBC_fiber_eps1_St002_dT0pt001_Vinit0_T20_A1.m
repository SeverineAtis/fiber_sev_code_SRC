...
DG_parameters.A = 1         ;  % Amplitude of the stream function
...
fiber_parameters.eps = 1.001   ;     % ellipse aspect ratio: epsilon =  b/a
fiber_parameters.St  = 0.02;     % particle Stokes number
...
result_file = 'DG_PBC_fiber_eps1_St002_Dt0pt001_A1';
...
ttl         = 'doublegyre PBC fiber eps=1 St=0.02 Dt=0.001 theta=RDM T=20 A=1';
