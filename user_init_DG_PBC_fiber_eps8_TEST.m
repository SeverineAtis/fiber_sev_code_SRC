...
fiber_parameters.St  = 0.2*10;     % particle Stokes number
...
result_file = 'DG_PBC_fiber_eps8_TEST';
...
ttl         = 'doublegyre PBC fiber eps=8 St=0.2 theta=RDM T=20 A=1 negative normal force';
